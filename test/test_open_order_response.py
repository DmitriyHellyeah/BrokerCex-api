...
from swagger_client.models.open_order_response import OpenOrderResponse  # noqa: E501
...
class TestOpenOrderResponse(unittest.TestCase):
    ...
    def testOpenOrderResponse(self):
        ...
        # model = swagger_client.models.open_order_response.OpenOrderResponse()  # noqa: E501
        pass
