...
class AccountMetricsResponse(object):
    ...
    def __init__(self, metrics=None):  # noqa: E501
        """AccountMetricsResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def metrics(self):
        """Gets the metrics of this AccountMetricsResponse.  # noqa: E501


        :return: The metrics of this AccountMetricsResponse.  # noqa: E501
    ...
    def metrics(self, metrics):
        """Sets the metrics of this AccountMetricsResponse.


        :param metrics: The metrics of this AccountMetricsResponse.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AccountMetricsResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AccountMetricsResponse):
            return False
