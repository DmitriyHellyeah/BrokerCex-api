...
class OpenOrderList(object):
    ...
    def __init__(self, orders=None):  # noqa: E501
        """OpenOrderList - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def orders(self):
        """Gets the orders of this OpenOrderList.  # noqa: E501


        :return: The orders of this OpenOrderList.  # noqa: E501
        :rtype: list[Order]
        """
        return self._orders
    ...
    def orders(self, orders):
        """Sets the orders of this OpenOrderList.


        :param orders: The orders of this OpenOrderList.  # noqa: E501
        :type: list[Order]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OpenOrderList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OpenOrderList):
            return False
